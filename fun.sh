...
data_ip="https://raw.githubusercontent.com/tukangtambalbann/tambalban/main/daftar"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/TUKANGTAMBALBANN"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
echo -e "${YELLOW}────────────────────────────────────────────${NC}"
sleep 0.6 & loading $!
echo -e " WELCOME TO TUKANGTAMBALBANN VPN SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
sleep 0.6 & loading $!
echo -e "${Green}[INFO] Sedang Memeriksa IP Address Tuan !!${NC}"
sleep 0.6 & loading $!
echo -e "${purple}────────────────────────────────────────────${NC}"
echo -e " AUTHOR : ${green}TUKANGTAMBALBANN VPN ${NC}${YELLOW}(${NC}${green}V 1.0${NC}${YELLOW})${NC}"
echo -e " TEAM TUKANGTAMBALBANN VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}────────────────────────────────────────────${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/tukangtambalbann/v3/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/tukangtambalbann/tambalban/main/daftar"
# USERNAME
rm -f /usr/bin/user
...
<b>My TUKANGTAMBALBANN</b>
<code>────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/TUKANGTAMBALBANN"}]]}' 
...
function udp_mini(){
wget -q https://raw.githubusercontent.com/tukangtambalbann/v3/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY TUKANGTAMBALBANN ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
reboot
